...
public class DBUtil {
	...
	private static String url = "jdbc:oracle:thin:@127.0.0.1:1521:orcl" ; // Database connection string,the character encoding is utf8
	 private static String DRVIER = "oracle.jdbc.OracleDriver";
	private static String user = "scott"; // Database account
	private static String password = "123"; // Database password
