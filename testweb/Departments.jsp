	...
	<form  id = "depForm"class="vote" action="" method="post">
		...
		<div style="float:right">
			...
			<table frame="box" width="480px" height="580px">
				...
				<tr>
					<td align=center><label for="DepLevel" class=" ">数字级别：</label> <input
					...
					<td align=center><label for="DepLevelName" class=" ">级别：</label> <input
						name="DepLevelName" class="form-control" id="DepLevelName"
						value=""></td>
				</tr>
				
				<tr>
					<td align=center><label for="DepType" class=" ">级别：</label>
...
<label><input id = "DepType0"name="DepType" type="radio" value="0" />行政单位 </label> 
				...
				<tr>
					...
					<td align=right>
						<button type="button" id="depCancel" onclick="ToCancel()" class="">&nbsp;重置&nbsp;</button>
						<button type="button" id ="delete" onclick="deleteDep()" class="">&nbsp;删除&nbsp;</button>
						<button type="button" id = "depSummit" onclick = "modifyDep()"class="">&nbsp;修改&nbsp;</button>
						<button type="button" id = "depAdd" onclick="toAddSub()">&nbsp;添加子属&nbsp;</button>
					</td>
