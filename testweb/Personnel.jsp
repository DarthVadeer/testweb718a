...
<script>
	...
	<div id="AddPersonnel" style="float:right">
		...
		<table id = "peopleList" border="1" cellspacing="0">
			...
			<tr>
				...
				<td>
					...
					<button class="" onclick="toModifyPersonnel()">&nbsp;&nbsp;查看&nbsp;&nbsp;</button>
					<button class="" onclick="PersonnelDelete()">&nbsp;&nbsp;删除&nbsp;&nbsp;</button>
