...
contentType: 'application/x-www-form-urlencoded; charset=UTF-8', 
			...
			depOptions+="<td>"+data[i].rolemenunames+"</td>";
...
<body>
	...
	<div id="AddRole" style="float:right ;  display:none">
 <br>
	<p id = "p1">添加角色</p>
		...
		<form class="vote" action="" method="post">
			<div>
				<table frame="box" width="480px" height="580px">
					...
					<tr>
						<td align=center>
							<Button onclick="toRoleList()">&nbsp;返回&nbsp;</Button>
	...
	<div id="RoleList"
		style="overflow-y:scroll; width:1400px; height:900px;">
   <button onclick="toAddRole()" style = "float : right">添加</button>
